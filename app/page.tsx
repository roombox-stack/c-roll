...
export default async function HomePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-ink text-white">
      ...
      <div aria-hidden className="pointer-events-none fixed left-1/2 top-[55vh] z-0 h-[400px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[140px]" style={{ background: 'rgba(255,107,0,0.16)' }} />
